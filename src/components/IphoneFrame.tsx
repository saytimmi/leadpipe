/**
 * iPhone 15 Pro frame component (based on Magic UI, MIT license)
 * Renders a realistic SVG iPhone frame with a slot for custom content.
 */
...
export default function IphoneFrame({ children, className, style, ...props }: IphoneFrameProps) {
  return (
    <div
    ...
    >
      ...
      >
        <g mask="url(#screenPunch)">
          ...
          />
          {/* Side buttons */}
          <path d="M0 171C0 170.448 0.447715 170 1 170H3V204H1C0.447715 204 0 203.552 0 203V171Z" fill="#2A2A2A" />
          <path d="M1 234C1 233.448 1.44772 233 2 233H3.5V300H2C1.44772 300 1 299.552 1 299V234Z" fill="#2A2A2A" />
          <path d="M1 319C1 318.448 1.44772 318 2 318H3.5V385H2C1.44772 385 1 384.552 1 384V319Z" fill="#2A2A2A" />
          <path d="M430 279H432C432.552 279 433 279.448 433 280V384C433 384.552 432.552 385 432 385H430V279Z" fill="#2A2A2A" />
          {/* Inner bezel */}
          <path
