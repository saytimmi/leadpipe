...
const steps: {
  ...
  },
  {
    ...
    opts: [
      { label: "До 50 000 ₸", emoji: "💰" },
      { label: "50 000 — 200 000 ₸", emoji: "💰💰" },
      { label: "200 000 — 500 000 ₸", emoji: "💰💰💰" },
      { label: "500 000+ ₸", emoji: "🔥" },
    ],
    disqualify: (val) => val === "До 50 000 ₸"
      ? "При бюджете до 50 000 ₸ LeadPipe пока не окупится. Рекомендуем начать с бюджета от 50 000 ₸ — тогда возвращайся, поможем!"
      : null,
  },
  {
