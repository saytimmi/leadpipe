    ...
    <section ref={ref} id="visibility" className="px-6 py-28 md:py-40 lg:px-10">
      <div className="mx-auto max-w-[1400px]">
        ...
        <motion.div
          ...
          className="mt-16 overflow-hidden rounded-2xl border border-white/[0.04] bg-surface md:mt-20"
        >
          <div className="p-4 md:p-8 lg:p-10">
            <div className="mb-5 flex items-center justify-between">
                ...
                >
                  ...
                  <div className="hidden items-center gap-2 md:flex">
                    <div className="flex-1">
                      <span className={`font-display text-xs font-700 ${c.winner ? "text-lime" : "text-warm"}`}>{c.id}</span>
                    ...
                    <span className={`w-20 text-center font-display text-lg font-800 ${c.paid > 0 ? "text-lime" : "text-warm"}`}>{c.paid}</span>
                  </div>
                  {/* Mobile */}
                  <div className="md:hidden">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex gap-4 font-body text-xs text-text-dim">
                        <span>{c.leads} заявок</span>
                        <span>{c.qualified} квалиф.</span>
                      </div>
                      <span className={`font-display text-lg font-800 ${c.paid > 0 ? "text-lime" : "text-warm"}`}>{c.paid} оплат</span>
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        {/* Callout */}
        <div className="mx-auto mt-10 max-w-xl space-y-3 text-center md:mt-14">
